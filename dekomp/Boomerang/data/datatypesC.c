...
int main(int argc, char *argv[], char *envp[]) {
    __size32 local0; 		// m[r28 + 4]{20}
    double local1; 		// m[r28 + 4]{228}
    __size32 local2; 		// m[r28 + 12]{50}
    double local3; 		// m[r28 + 12]{218}
