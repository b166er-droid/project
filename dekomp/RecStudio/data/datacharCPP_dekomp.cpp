...
)
{
    ...
    if(_t19 != 0) {
        ...
        __fmode = _t19;
        _v28 = _t19;
         *__esp =  *((intOrPtr*)(_t31 + 16));
        __setmode();
        _v28 = __CRT_fmode;
         *__esp =  *((intOrPtr*)(_t31 + 48));
        __setmode();
        _v28 = __CRT_fmode;
        _t19 =  *((intOrPtr*)(_t31 + 80));
         *__esp = _t19;
        __setmode();
    }
    ___p__fmode();
...
)
{
    ...
    if( &_v84 == 0) {
        _v124 = _t82;
        L00401C80(_t85, _t94, "  VirtualQuery failed for %d bytes at address %p", 28);
        _t121 = _t120;
        _t115 = _t114;
        _t70 =  *4247644;
        if(_t70 == 0) {
...
L18:
                            _t70 = _t83[8];
                            if(_t70 != 1) {
                                L00401C80(_t85, _t94, "  Unknown pseudo relocation protocol version %d.\n", _t70);
                                0;
                                0;
                                0;
...
)
{
    ...
    if( &_v56 == 0) {
        _v96 = __eax;
        L00401C80(__ecx, __edx, "  VirtualQuery failed for %d bytes at address %p", 28);
        _t108 = __edx;
        _t104 = __ecx;
        _t58 =  *4247644;
        if(_t58 == 0) {
...
L24:
                                if(_t72 <  &__RUNTIME_PSEUDO_RELOC_LIST_END__) {
                                    ...
                                    do {
                                        ...
                                        _t58 = L00401CD0(_t84 + 4194304, 4,  &_v120);
...
L17:
                            _t58 = _t72[8];
                            if(_t58 != 1) {
                                L00401C80(_t74, _t83, "  Unknown pseudo relocation protocol version %d.\n", _t58);
                                0;
                                0;
                                0;
                                goto __imp____register_frame_info;
...
L18:
                                ...
                                if(_t88 == 16) {
                                    ...
                                    _t58 = L00401CD0(_t62, 2,  &_v120);
                                    continue;
                                } else {
                                    if(_t88 == 32) {
                                        _v120 = _t104;
                                        _t58 = L00401CD0(_t62, 4,  &_v120);
                                        continue;
                                    } else {
                                        if(_t88 == 8) {
                                            _t95 =  *_t62 & 255;
                                            ...
                                            _t58 = L00401CD0(_t62, 1,  &_v120);
                                            continue;
                                        } else {
                                            _v144 = _t88;
                                             *__esp = "  Unknown pseudo relocation bit size %d.\n";
                                            _v120 = 0;
                                            _t58 = L00401C80(_t76, _t88);
                                            goto L23;
                                        }
                                    }
                                }
...
L15:
                            if(_t30 <  &__RUNTIME_PSEUDO_RELOC_LIST_END__) {
                                ...
                                do {
                                    ...
                                    _t24 = L00401CD0(_t40 + 4194304, 4,  &_v16);
...
L8:
                        _t24 = _t30[8];
                        if(_t24 != 1) {
                            L00401C80(_t32, _t39, "  Unknown pseudo relocation protocol version %d.\n", _t24);
                            0;
                            0;
                            0;
                            goto __imp____register_frame_info;
...
L9:
                            ...
                            if(_t44 == 16) {
                                ...
                                _t24 = L00401CD0(_t28, 2,  &_v16);
                                continue;
                            } else {
                                if(_t44 == 32) {
                                    _v16 = _t56;
                                    _t24 = L00401CD0(_t28, 4,  &_v16);
                                    continue;
                                } else {
                                    if(_t44 == 8) {
                                        _t51 =  *_t28 & 255;
                                        ...
                                        _t24 = L00401CD0(_t28, 1,  &_v16);
                                        continue;
                                    } else {
                                        _v40 = _t44;
                                         *__esp = "  Unknown pseudo relocation bit size %d.\n";
                                        _v16 = 0;
                                        _t24 = L00401C80(_t34, _t44);
                                        goto L14;
                                    }
                                }
                            }
            ...
            if(_t55 == 63) {
                ...
                if(_t55 == 91) {
                    ...
                    if( *(__ebp - 1) == 0) {
                        ...
                        if(_t66[1] == 33) {
                            _t50 =  &(_t66[2]);
                            if(L004020B0(_t50,  *(__esp + 16), _t62) == 0) {
                                _t44 = _t66[2] & 255;
                                _t63 =  *(__esp + 20);
                                if(_t44 == 93) {
                                    _t50 =  &(_t66[3]);
...
L42:
                            ...
                            _t45 = L004020B0(_t39,  *(__esp + 16), _t62);
                            _t66 = _t45;
                            if(_t45 == 0) {
L49:
                                _t41 = 93;
...
)
{
    ...
    L00402610( *((intOrPtr*)(__eax + 8)), __edx);
    _t7 =  *((intOrPtr*)(__eax + 4));
    if(_t7 != 0) {
        _t7 = L00402630(_t7, __edx);
    }
    _free(__eax);
    __esp = __esp + 20;
    return _t7;
...
)
{
    ...
    _v32 = 0;
    _v76 = _t153;
    _t155 = L004022C0( &_v44);
    __eflags = _t155;
    if(_t155 == 0) {
        _t157 = L00402020(_v76, _v56);
        __eflags = _t157;
        if(_t157 == 0) {
            _t283 = __esp;
...
L47:
             ...
             *__esp =  &_v44;
            __eflags = _v56 | 128;
            _t155 = L00402670(_v76, _v96, _v56 | 128);
L4:
            __eflags = _t155;
            if(_t155 != 0) {
                goto L1;
...
L20:
                                                        __ebx = _t284 + 12;
                                                        _t193 = L00402320(_v68, _v56, __ebx);
                                                        __eflags = _t193;
                                                        if(_t193 != 0) {
                                                            continue;
                                                        } else {
...
{// addr = 0x00402C20
    ...
    _t21 = L00402670(_t35, _a12, _t45, _t48);
    _t38 = _t21;
    if(_t21 == 2) {
        if(_t45 == 0) {
            goto L5;
...
L3:
    ...
    _t11 = L00403120( *((intOrPtr*)(__ebx + 272)), __ebx);
    if(_t11 != 0) {
        goto L3;
    }
    return _t11;
...
)
{
    ...
    return L00403840( &_v32, __ecx, __edi + 3 -  &_v32);
}
...
)
{
    ...
    L00403E90(_v40, 1, __edx, _t70);
     *((intOrPtr*)(_t70 + 12)) =  *((intOrPtr*)(_t70 + 32));
     *(_t70 + 4) =  *(_t70 + 4) | 448;
    L004036D0( *(_t70 + 4) & 32 | 69, _t70);
     *((intOrPtr*)(_t70 + 8)) =  *((intOrPtr*)(_t70 + 8)) + _t72 + 1;
    _t42 = L00403980(_v36, _t70, _v32);
    __esp = __esp + 28;
    _pop(__ebx);
    _pop(__esi);
    _pop(__edi);
...
)
{
    ...
    __esi = _t26;
    if(_v32 == -32768) {
        L004038F0(_v36, __eax, _t26);
        _t29 = ___freedtoa(__eax, __esi);
        __esp = __esp + 68;
        return _t29;
    } else {
        L004041C0(_v36, _t33, _t26, __eax);
...
)
{
    ...
    __edi = _t31;
    if(_v32 == -32768) {
        L004038F0(_v36, __eax, _t31);
        _t34 = ___freedtoa(__eax, __edi);
        __esp = __esp + 64;
        return _t34;
    } else {
        L00403E90(_v36, _t41, _t31, __eax);
...
L10:
            ...
            L004041C0(_v36, _t78, __edi, __eax);
            goto L13;
        } else {
            _t55 =  *(__eax + 12);
            if(_t78 > _t55) {
                ...
                L00403E90(_v36, _t78, __edi, __eax);
...
L83:
    ...
    st0 = _t429;
    if((_t213 & 17664) == 1280) {
        _t215 = L004038F0(_t293, _t393, "Inf");
        goto L83;
    } else {
        _t353 = _t351 & 32767;
        if(_t353 == 0) {
...
L81:
                                            ...
                                            L004036D0( *(_t393 + 4) & 32 | 80, _t393);
                                             *(_t393 + 8) =  *(_t393 + 8) + _v104;
                                             *(_t393 + 4) =  *(_t393 + 4) | 448;
                                            asm("cdq ");
                                            _t215 = L00403980(_v92, _t393, _t393);
                                            goto L83;
                                        }
                                        goto L81;
                                    } else {
...
L8:
                    ...
                    switch( *((intOrPtr*)((_t286 & 255) * 4 +  &M0040A1E0))) {
                        case 0:
                            __eax = __esp[4];
                            if(__eax != 0) {
                                goto L77;
...
L93:
                            ...
                            __edx = __eax;
                            __eax = __ebx;
                            __eax = L00403730(__ebx,  &(__esp[0xb]), __edx);
                            goto L4;
                        case 0x11:
                            __eax = __edi;
                            if(__esp[5] == 3) {
                            ...
                            if(__eax == 117) {
                                ...
                                __edi =  &(__esp[0xb]);
                                __ecx = __esp[9];
                                __eax = L00403BB0(__eax, __esp[9], __edx, __edi);
                                goto L4;
                            }
                        case 0x12:
...
L66:
                                ...
                                __esp[8] = __ax;
                                __eax =  &(__esp[8]);
                                __eax = L00403730( &(__esp[8]),  &(__esp[0xb]), 1);
                            } else {
                                __eax =  *__eax;
                                __ecx =  &(__esp[0xb]);
                                __edx = 1;
                                ...
                                __esp[8] = __al;
                                __eax =  &(__esp[8]);
                                __eax = L00403840( &(__esp[8]),  &(__esp[0xb]), 1);
                            }
                            goto L4;
                        case 0x14:
...
L55:
                            ...
                            __ecx =  &(__esp[0xb]);
                            __edx = __esp[9];
                            __eax = L00403980(__esp[8],  &(__esp[0xb]), __edx);
                            goto L4;
                        case 0x15:
                            __esp[0xc] = __esp[0xc] | 32;
                            __esp[0xc] = __esp[0xc] | 32;
...
L46:
                        ...
                        case 0x1c:
                             ...
                             *__esp =  &(__esp[0xb]);
                            __eax = 120;
                            __eax = L00403BB0(120, __esp[9], __edx);
                            goto L4;
                        case 0x1d:
                            __edx = __esp[5];
                            __eax = __ebp;
                            ...
                            __ecx =  &(__esp[0xb]);
                            __eax = __ebx;
                            __eax = L00403840(__ebx,  &(__esp[0xb]), __edx);
                            goto L4;
                        case 0x1e:
                            _t300 =  *(__ecx + 1) & 255;
                            __ecx = _t307;
...
{// addr = 0x00405710
    ...
    _t18 = L00405590(__ebx, _a8, _a12, __edx, __ecx, _t22);
    __esp = __esp + 52;
    return _t18;
}
...
{// addr = 0x00405A40
    ...
    return L004059B0(__ebx, _t14 & 65535, __edx, __edi);
}
